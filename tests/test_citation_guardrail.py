...
async def test_citation_guardrail_fail_closed():
    ...
    mock_retriever.retrieve.return_value = RetrievalResult(
        chunks=[
            DocChunk(doc_id="valid_doc", chunk_id="0", source_title="Valid", source_path="mock_path", text="content")
        ],
        scores=[1.0],
    ...
    mock_llm.chat.return_value = ChatResult(
        text='{"plan": "answer", "sql": null, "answer_text": "Fact.", "citations": ["fake_doc:99"]}', usage={}
    )
